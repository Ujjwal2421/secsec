...
const EditEquityForm = () => {
   const[data,setData]=useState(''); 
    ...
    const handleSubmit=(e)=>{
        ...
        axios.patch(`http://localhost:5251/api/Equity/${data}`, sendData)
        .then((response) => {
    ...
    const handleDelete=(e)=>{
      axios.delete(`http://localhost:5251/api/Equity/${data}`).then((response) => {
        console.log(response);
        alert("Data Deleted")
    ...
    const handleEditSubmit=(e)=>{
        e.preventDefault()
        axios.get(`http://localhost:5251/api/Equity/${data}`)
        .then(res => {
          console.log(res.data);
          const updatedFormData = {
            ...formData,
            field0: res?.data?.securityId,
            field1: res?.data?.securityName,
            field2: res?.data?.securityDescription,
            field3: res?.data?.hasPosition,
            field4: res?.data?.isActiveSecurity,
            field5: res?.data?.lotSize,
            field6: res?.data?.bbgUniqueName,
            field7: res?.data?.cusip,
            field8: res?.data?.isin,
            field9: res?.data?.sedol,
            field10: res?.data?.bloombergTicker,
            field11: res?.data?.bloombergUniqueID,
            field12: res?.data?.bbgGlobalID,
            field13: res?.data?.tickerAndExchange,
            field14: res?.data?.isADRFlag,
            field15: res?.data?.adrUnderlyingTicker,
            field16: res?.data?.adrUnderlyingCurrency,
            field17: res?.data?.sharesPerADR,
            field18: res?.data?.ipoDate,
            field19: res?.data?.pricingCurrency,
            field20: res?.data?.settleDays,
            field21: res?.data?.totalSharesOutstanding,
            field22: res?.data?.votingRightsPerShare,
            field23: res?.data?.averageVolume20D,
            field24: res?.data?.beta,
            field25: res?.data?.shortInterest,
            field26: res?.data?.returnYTD,
            field27: res?.data?.volatility90D,
            field28: res?.data?.pfAssetClass,
            field29: res?.data?.pfCountry,
            field30: res?.data?.pfCreditRating,
            field31: res?.data?.pfCurrency,
            field32: res?.data?.pfInstrument,
            field33: res?.data?.pfLiquidityProfile,
            field34: res?.data?.pfMaturity,
            field35: res?.data?.pfnaicsCode,
            field36: res?.data?.pfRegion,
            field37: res?.data?.pfSector,
            field38: res?.data?.pfSubAssetClass,
            field39: res?.data?.countryOfIssuance,
            field40: res?.data?.exchange,
            field41: res?.data?.issuer,
            field42: res?.data?.issueCurrency,
            field43: res?.data?.tradingCurrency,
            field44: res?.data?.bbgIndustrySubGroup,
            field45: res?.data?.bloombergIndustryGroup,
            field46: res?.data?.bloombergSector,
            field47: res?.data?.countryOfIncorporation,
            field48: res?.data?.riskCurrency,
            field49: res?.data?.openPrice,
            field50: res?.data?.closePrice,
            field51: res?.data?.volume,
            field52: res?.data?.lastPrice,
            field53: res?.data?.askPrice,
            field54: res?.data?.bidPrice,
            field55: res?.data?.peRatio,
            field56: res?.data?.dividendDeclaredDate,
            field57: res?.data?.dividendExDate,
            field58: res?.data?.dividendRecordDate,
            field59: res?.data?.dividendPayDate,
            field60: res?.data?.dividendAmount,
            field61: res?.data?.frequency,
            field62: res?.data?.dividendType,
          }; 
  ...
  return (
    <div>   
        ...
        <input className="form-control me-2" type="search" placeholder="ID of Equity" aria-label="Search" value={data} onChange={(e)=>setData(e.target.value)}/>
        ...
        <button className="btn btn-outline-danger"  onClick={handleDelete}>Delete</button>
                    ...
                    <div className="form-container">
                      ...
                      <label>Security Id:</label>
                        <input type="number" id="number" name="field0" class="right-align" value={formData.field0} onChange={handleInputChange} disabled/><br/><br/>
